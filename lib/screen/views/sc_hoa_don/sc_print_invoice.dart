...
class _ScreenPrintinvoiceState extends State<ScreenPrintinvoice> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children: [
            ...
            Text(
              ...
              style : StyleApp.style600.copyWith(
                  fontSize: 25,wordSpacing: 6,letterSpacing: 3),textAlign: TextAlign.center,),
            10.height,
            Text(
              "Số 18, Trịnh Văn Bô, Phương Canh, Nam Từ Liêm, Hà Nội",
              style: StyleApp.style400,textAlign: TextAlign.center,),
            20.height,
            Text(
              "Phiếu Thanh Toán",
              style: StyleApp.style600.copyWith(fontSize: 23),textAlign: TextAlign.center,),
            20.height,
            Row(
              children: [
                Column(
                  ...
                  children: [
                    Text("Tầng: ${widget.model.idfloor}",style: StyleApp.style500,),
                    5.height,
                    Text("Bàn số: ${widget.model.idTable}",style: StyleApp.style500,),
                  ],
                ).paddingLeft(40).expand(flex: 1),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    Text("Giờ vào: ${widget.model.timeIn}",style: StyleApp.style500,),
                    5.height,
                    Text("Giờ ra: $timeout",style: StyleApp.style500,),
                  ],
                ).paddingRight(40).expand(flex: 1),
              ],
            ),
            20.height,
            Align(alignment: Alignment.centerLeft,child: Text("Nv phụ trách: ${widget.model.user!.userName}",style: StyleApp.style500.copyWith(fontSize: 13),)),
            5.height,
            Table(
              ...
              children: [
                buildRow(["Tên Sản Phẩm","Đơn giá","SL","Thành tiền"],isheader: true),
              ],
            ),
            Table(
      ...
      bottomSheet: itemButton(
          ...
          width: MediaQuery.of(context).size.width,
          onPress: () {
            player.play(AssetSource('sound/cash_pay.mp3'),volume: SizeConfig.screenHeight);
            finish(context);
            finish(context);
  ...
  TableRow buildRow(List<String> cells,{bool isheader = false}) => TableRow(
      children: cells.map((cells) => Padding(
          padding:const EdgeInsets.all(10),
          child: Text(cells,style: isheader ? StyleApp.style600 : StyleApp.style400,))
      ).toList()
  );
}
