  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        10.height,
        itemAdd(
          count: widget.model.soluong.validate(),
          model: widget.model,
          ontap1: () => setState(() {
            if (widget.model.soluong.validate() > 1) {
              widget.model.soluong = widget.model.soluong.validate() - 1;
            }
          }),
          ontap2: () => setState(() {
            widget.model.soluong = widget.model.soluong.validate() + 1;
        ...
        itemButton(
          ...
          onPress: () {
            if (widget.model.soluong.validate() <= 0) {
